	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<input type="submit" name="login" class="form-control btn btn-primary submit px-3"></input>
	            </div>
...
// vlidasi username dan password yang di submid oleh user
// lakukan perbandingn dengan nilai hard-code atau username dan password nya
if ($username == "admin" && $password == '12345'){
// jika nilai username dan password yang di inputkan user sama dengan nilai yang di tentukan
// arahkan ke ahalamn dashboard
// set session username
    $_SESSION['username'] = $username;
    header("Location: home.php");
    exit();
}else{
// jika username dan password berbeda, redrect atau tetap di halaman index.php/login
