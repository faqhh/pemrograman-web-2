...
<form action="{{ url('hasil') }}" method="POST">
    ...
    <div class="form-group row">
        <label class="col-4 col-form-label" for="ttl">Tempat Tanggal Lahir</label>
        <div class="col-8">
            <input id="ttl" name="ttl" placeholder="Masukan TTL" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="hobi" name="hobi" placeholder="Masukan Hobi" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
